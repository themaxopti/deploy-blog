...
import { savePhoto } from "../../redux/auth-reducer"
...
const UserPage = (props) => {
    ...
    useEffect(async () => {
        try {
            ...
            // await props.getPostsUserThunk(props.match.params.userId)
...
export default compose(
    LanguageHoc,
    React.memo,
    connect(mapStateToProps, { changeLanguageThunk,getLanguageProjectThunk,savePhoto, showPostsUserThunk, addTodoThunk, getAllPostsUser, addPostUser, addPost, authProfile, changeTheme, changeHeader, getProfileUser, getPostsUserThunk, getTodosUserThunk, getUsers }),
    withRouter
)(UserPage)
